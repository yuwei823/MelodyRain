...
import type { VideoExportFrameRange, VideoExportQuality } from "../lib/video-export";
...
export function useVideoExport(options: UseVideoExportOptions) {
  ...
  const start = useCallback(async (
    ...
    frameRange: VideoExportFrameRange,
  ) => {
    ...
    try {
      ...
      form.append("startFrame", String(frameRange.startFrame));
      form.append("endFrame", String(frameRange.endFrame));
